  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className={cn(
          "pointer-events-none absolute -inset-px -z-10 hidden rounded-[inherit] opacity-0 blur-md transition-opacity duration-500 md:block",
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-20 hidden rounded-[inherit] ring-1 ring-transparent transition duration-500 md:block group-hover/glowing-shadow:ring-amber-500/35 group-focus-within/glowing-shadow:ring-amber-500/35 dark:group-hover/glowing-shadow:ring-amber-400/30 dark:group-focus-within/glowing-shadow:ring-amber-400/30"
      />
